...
_SYSTEM_PROMPT = (
    ...
    "   - RIGHT: 'autonomous cinematography', 'active camera', 'video generation'\n"
    ...
    "8. KEYWORD LENGTH: Each keyword MUST be 1-3 words. NEVER use phrases longer than "
    "3 words. The search system ANDs every word together, so long phrases return zero results.\n"
    "   - WRONG: 'real-time autonomous camera control for sports events' (7 words, too long)\n"
    "   - WRONG: 'sports highlight generation via multi-object tracking' (6 words, too long)\n"
    "   - RIGHT: 'camera control', 'sports tracking', 'highlight detection' (2 words each)\n"
    "   Split long ideas into MULTIPLE short keywords instead of one long phrase.\n\n"
    "9. SPECIFICITY: Avoid ultra-generic single words like 'vision', 'learning', 'network'. "
    "Combine a domain word with a method word to make 2-word keywords.\n"
    "   - WRONG: 'computer vision' (too broad)\n"
    "   - RIGHT: 'sports vision', 'pose estimation', 'action recognition'\n\n"

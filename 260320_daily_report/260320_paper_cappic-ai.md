# CAPP!C_AI 논문 리포트 (2026-03-20)

> 수집 81 | 필터 79 | 폐기 11 | 평가 70 | 출력 48 | 기준 50점

검색 윈도우: 2026-03-19T00:00:00+00:00 ~ 2026-03-20T00:30:00+00:00 | 임베딩: en_synthetic | run_id: 44
...
## 1위: HORNet: Task-Guided Frame Selection for Video Question Answering with Vision-Language Models

- arXiv: http://arxiv.org/abs/2603.18850v1
- PDF: https://arxiv.org/pdf/2603.18850v1
- 코드: https://github.com/ostadabbas/HORNet
- 발행일: 2026-03-19
- 카테고리: cs.CV
...
**활용 인사이트**
99% 프레임 감소로 실시간 주요 장면 자동 추출 가능하며 훈련 파라미터 100만 미만으로 경량화

## 2위: DyMoE: Dynamic Expert Orchestration with Mixed-Precision Quantization for Efficient MoE Inference on Edge
...
**활용 인사이트**
DyMoE로 TTFT 3.44x-22.7x, TPOT 최대 14.58x 속도 향상으로 실시간 엣지 처리 가능

## 3위: EdgeCrafter: Compact ViTs for Edge Dense Prediction via Task-Specialized Distillation

- arXiv: http://arxiv.org/abs/2603.18739v1
- PDF: https://arxiv.org/pdf/2603.18739v1
- 코드: https://intellindust-ai-lab.github.io/projects/EdgeCrafter/
- 발행일: 2026-03-19
- 카테고리: cs.CV
...
**활용 인사이트**
10M 파라미터 미만으로 COCO 51.7 AP 달성, 스포츠 선수 동작 분석에 최적화

## 4위: Rethinking MLLM Itself as a Segmenter with a Single Segmentation Token

- arXiv: http://arxiv.org/abs/2603.19026v1
- PDF: https://arxiv.org/pdf/2603.19026v1
- 코드: https://github.com/ANDYZAQ/SELF1E
- 발행일: 2026-03-19
- 카테고리: cs.CV
- 점수: final 98.4 (llm_adjusted:98 = base:85 + bonus:+13)
- 플래그: 엣지, 실시간, 코드 공개
...
**활용 인사이트**
단일 분할 토큰으로 외부 디코더 없이 선수와 객체 분할 가능, 정확도 유지하면서 효율성 향상

## 5위: Balancing Performance and Fairness in Explainable AI for Anomaly Detection in Distributed Power Plants Monitoring
...
**활용 인사이트**
LightGBM F1-score 0.99로 스포츠 경기 이상 동감지 및 전략 분석에 활용 가능

## 6위: Towards High-Quality Image Segmentation: Improving Topology Accuracy by Penalizing Neighbor Pixels

- arXiv: http://arxiv.org/abs/2603.18671v1
- PDF: https://arxiv.org/pdf/2603.18671v1
- 코드: https://jmlipman.github.io/SCNP-SameClassNeighborPenalization
- 발행일: 2026-03-19
- 카테고리: cs.CV
...
**활용 인사이트**
SCNP 방법을 적용하면 경기 장면에서 선수와 객체의 정확한 분할이 가능해져 하이라이트 영상 생성과 분석 정확도가 향상됩니다.

## 7위: Scaling Sim-to-Real Reinforcement Learning for Robot VLAs with Generative 3D Worlds

- arXiv: http://arxiv.org/abs/2603.18532v1
- PDF: https://arxiv.org/pdf/2603.18532v1
- 발행일: 2026-03-19
- 카테고리: cs.RO, cs.AI, cs.LG
...
**활용 인사이트**
생성적 3D 세계를 활용해 다양한 스포츠 시나리오 시뮬레이션을 구축하고, 실제 경기 데이터와 결합해 선수 동작과 전략을 분석할 수 있습니다.

## 8위: A Pipelined Collaborative Speculative Decoding Framework for Efficient Edge-Cloud LLM Inference
...
**활용 인사이트**
PicoSpec을 적용하면 엣지 디바이스와 클라우드의 계산 능력을 효율적으로 활용하여 실시간 영상 처리 속도를 최대 2.9배 향상시킬 수 있습니다.

## 9위: R&D: Balancing Reliability and Diversity in Synthetic Data Augmentation for Semantic Segmentation

- arXiv: http://arxiv.org/abs/2603.18427v1
- PDF: https://arxiv.org/pdf/2603.18427v1
- 코드: https://github.com/chequanghuy/Enhanced-Generative-Data-Augmentation-for-Semantic-Segmentation-via-Stronger-Guidance}{https://github.com/chequanghuy/Enhanced-Generative-Data-Augmentation-for-Semantic-Segmentation-via-Stronger-Guidance}
- 발행일: 2026-03-19
- 카테고리: cs.CV, cs.AI
...
**활용 인사이트**
제안된 파이프라인을 적용하면 데이터 부족 상황에서도 모델의 일반화 성능을 향상시키고 실제 스포츠 이미지의 품질을 개선할 수 있습니다.

## 10위: SEAR: Simple and Efficient Adaptation of Visual Geometric Transformers for RGB+Thermal 3D Reconstruction

- arXiv: http://arxiv.org/abs/2603.18774v1
- PDF: https://arxiv.org/pdf/2603.18774v1
- 코드: https://www.github.com/Schindler-EPFL-Lab/SEAR
- 발행일: 2026-03-19
- 카테고리: cs.CV
...
## 11위: Translating MRI to PET through Conditional Diffusion Models with Enhanced Pathology Awareness

- arXiv: http://arxiv.org/abs/2603.18896v1
- PDF: https://arxiv.org/pdf/2603.18896v1
- 코드: https://github.com/ai-med/PASTA
- 발행일: 2026-03-19
- 카테고리: cs.CV, cs.AI
...
**활용 인사이트**
스포츠 영상의 품질을 향상시키면서 중요한 세부사항을 보존하여 전문가 수준의 영상을 생성할 수 있음

## 12위: CRAFT: Aligning Diffusion Models with Fine-Tuning Is Easier Than You Think
...
**활용 인사이트**
최소한의 컴퓨팅 자원으로 rk3588 엣지 디바이스에 AI 모델을 효율적으로 배포할 수 있음

## 13위: ADAPT: Attention Driven Adaptive Prompt Scheduling and InTerpolating Orthogonal Complements for Rare Concepts Generation
...
**활용 인사이트**
텍스트-이미지 합성 기술을 적용하여 희귀한 개념의 스포츠 장면을 생성하고, 주의 점수와 직교 구성 요소를 활용한 사진처럼 보정된 영상을 제작할 수 있습니다.

## 14위: Modeling the Impacts of Swipe Delay on User Quality of Experience in Short Video Streaming

- arXiv: http://arxiv.org/abs/2603.18575v1
- PDF: https://arxiv.org/pdf/2603.18575v1
- 발행일: 2026-03-19
- 카테고리: cs.MM
...
## 15위: GenMFSR: Generative Multi-Frame Image Restoration and Super-Resolution
...
**활용 인사이트**
다중 프레임 정렬을 통해 원본 영상의 해상도를 향상시키고 저주파 아티팩트를 방지할 수 있음

## 16위: Counting Circuits: Mechanistic Interpretability of Visual Reasoning in Large Vision-Language Models
...
**활용 인사이트**
카운팅 회로 접근법을 사용하여 스포츠 전용 AI 모델을 개발하고, 가벼운 개입 전략으로 모델을 미세조정하여 정확도를 향상시킬 수 있습니다.

## 17위: Through the Looking-Glass: AI-Mediated Video Communication Reduces Interpersonal Trust and Confidence in Judgments

- arXiv: http://arxiv.org/abs/2603.18868v1
- PDF: https://arxiv.org/pdf/2603.18868v1
- 발행일: 2026-03-19
- 카테고리: cs.HC, cs.AI, cs.MM
- 점수: final 84.0 (llm_adjusted:80 = base:80 + bonus:+0)
...
**활용 인사이트**
AI 비디오 보정 기술을 활용하여 실시간 스포츠 촬영 영상의 품질을 향상시키고, 신뢰도 유지하며 SNS 플랫폼에 최적화된 콘텐츠를 생성할 수 있습니다.

## 18위: FILT3R: Latent State Adaptive Kalman Filter for Streaming 3D Reconstruction

- arXiv: http://arxiv.org/abs/2603.18493v1
- PDF: https://arxiv.org/pdf/2603.18493v1
- 코드: https://github.com/jinotter3/FILT3R
- 발행일: 2026-03-19
...
**활용 인사이트**
FILT3R의 적응 칼만 필터를 엣지 디바이스에 통합하여 스포츠 영상의 3D 재구성 품질을 향상시키고, 선수 움직임과 전략 분석을 개선할 수 있습니다.

## 19위: Generalized Hand-Object Pose Estimation with Occlusion Awareness
...
**활용 인사이트**
GenHOI 프레임워크를 적용하여 가려진 상황에서도 정확한 동작 분석이 가능하며, 실시간으로 fps 30 이상의 분석 속도를 제공할 수 있습니다.

## 20위: Improving Joint Audio-Video Generation with Cross-Modal Context Learning
...
**활용 인사이트**
Cross-Modal Context Learning을 활용한 오디오-비디오 생성 모델로 경기의 중요 순간을 자동 감지하고, 짧은 시간 내에 고품질 하이라이트 영상을 생성할 수 있습니다.

## 21위: DA-Mamba: Learning Domain-Aware State Space Model for Global-Local Alignment in Domain Adaptive Object Detection

- arXiv: http://arxiv.org/abs/2603.18757v1
...
**선정 근거**
DA-Mamba는 도미인 적응 객체 감지 기술로 스포츠 장면에서 선수와 객체를 정확히 추적하는 데 적합합니다.

**활용 인사이트**
경기 영상에서 선수와 공의 움직임을 실시간으로 추적하고 분석하여 전략적 인사이트를 제공할 수 있습니다.

## 22위: TAU-R1: Visual Language Model for Traffic Anomaly Understanding

- arXiv: http://arxiv.org/abs/2603.19098v1
- PDF: https://arxiv.org/pdf/2603.19098v1
- 코드: https://github.com/siri-rouser/TAU-R1
- 발행일: 2026-03-19
- 카테고리: cs.CV
...
**선정 근거**
TAU-R1의 비전-언어 모델은 스포츠 장면의 이해와 분석에 활용될 수 있는 강력한 프레임워크입니다.

**활용 인사이트**
경기 중 비정상적인 플레이나 전략을 실시간으로 감지하고 분석하여 선수와 코치에게 피드백을 제공합니다.

## 23위: Unleashing the Power of Simplicity: A Minimalist Strategy for State-of-the-Art Fingerprint Enhancement

- arXiv: http://arxiv.org/abs/2603.19004v1
- PDF: https://arxiv.org/pdf/2603.19004v1
- 발행일: 2026-03-19
- 카테고리: cs.CV
- 점수: final 72.8 (llm_adjusted:66 = base:58 + bonus:+8)
- 플래그: 엣지, 코드 공개
...
**선정 근거**
지문 향상 기술은 스포츠 사진 및 영상의 품질 향상에 간접적으로 적용 가능합니다.

**활용 인사이트**
저조도 환경에서 촬영된 스포츠 영상의 노이즈를 줄이고 선명도를 높여 시각적 품질을 개선합니다.

## 24위: Measuring 3D Spatial Geometric Consistency in Dynamic Generated Videos

- arXiv: http://arxiv.org/abs/2603.19048v1
- PDF: https://arxiv.org/pdf/2603.19048v1
- 코드: https://github.com/tj12323/SGC
- 발행일: 2026-03-19
- 카테고리: cs.CV
...
**선정 근거**
3차원 공간 기하 일관성 평가는 스포츠 하이라이트 영상의 품질 검증에 유용합니다.

**활용 인사이트**
다중 카메라 각도에서 촬영된 영상의 기하학적 일관성을 평가하여 최적의 시각적 효과를 갖는 하이라이트를 생성합니다.

## 25위: TexEditor: Structure-Preserving Text-Driven Texture Editing

- arXiv: http://arxiv.org/abs/2603.18488v1
- PDF: https://arxiv.org/pdf/2603.18488v1
- 코드: https://github.com/KlingAIResearch/TexEditor
- 발행일: 2026-03-19
- 카테고리: cs.CV
- 점수: final 68.8 (llm_adjusted:61 = base:58 + bonus:+3)
- 플래그: 코드 공개
...
**선정 근거**
텍스처 편집 기술은 스포츠 이미지의 시각적 품질 향상에 활용될 수 있습니다.

**활용 인사이트**
경기 사진에서 유니폼이나 장비의 텍스처를 보정하여 더 전문적인 품질의 이미지를 생성합니다.

## 26위: Click-to-Ask: An AI Live Streaming Assistant with Offline Copywriting and Online Interactive QA
...
**선정 근거**
실시간 상호작용 개념은 프로젝트의 소셜 미디어 플랫폼에 적용 가능하며, 오프라인-온라인 아키텍처는 AI 촬영 디바이스의 처리 파이프라인에 적합합니다.

**활용 인사이트**
질문 인식 정확도 0.913과 응답 품질 점수 0.876을 바탕으로 시청자와의 실시간 상호작용 기능을 구현하여 콘텐츠 참여도를 높이고 스포츠 경기 하이라이트 영상의 효과적인 공유를 지원할 수 있습니다.

## 27위: LVOmniBench: Pioneering Long Audio-Video Understanding Evaluation for Omnimodal LLMs
...
**선정 근거**
장시간 오디오-비디오 이해 기술이 스포츠 경기 분석과 간접적으로 관련

## 28위: ADMM-Based Distributed MPC with Control Barrier Functions for Safe Multi-Robot Quadrupedal Locomotion
...
**선정 근거**
Movement analysis techniques could be indirectly applicable to sports motion analysis

## 29위: Accurate and Efficient Multi-Channel Time Series Forecasting via Sparse Attention Mechanism

- arXiv: http://arxiv.org/abs/2603.18712v1
...
**선정 근거**
스포츠 성능 데이터 분석에 시계열 예측 기술이 직접적으로 적용 가능하며, 스파어 어텐션 메커니즘은 엣지 디바이스에서의 효율적인 실시간 분석에 유용합니다.

**활용 인사이트**
다채널 시계열 데이터를 분석하여 선수들의 동작 패턴과 경기 전략을 예측하고, 스파어 어텐션을 통해 중요한 순간을 효율적으로 식별하여 하이라이트 영상을 생성할 수 있습니다.

## 30위: Attack by Unlearning: Unlearning-Induced Adversarial Attacks on Graph Neural Networks

- arXiv: http://arxiv.org/abs/2603.18570v1
- PDF: https://arxiv.org/pdf/2603.18570v1
- 발행일: 2026-03-19
- 카테고리: cs.LG, cs.CR
- 점수: final 67.2 (llm_adjusted:59 = base:56 + bonus:+3)
- 플래그: 코드 공개
...
**선정 근거**
GNN 언러닝 기술로 스포츠 데이터 처리에 잠재적 적용 가능

## 31위: Do VLMs Need Vision Transformers? Evaluating State Space Models as Vision Encoders

- arXiv: http://arxiv.org/abs/2603.19209v1 | 2026-03-19 | final 66.4
...
-> 비전 모델 평론이지만 스포츠나 엣지 디바이스에 특화되지 않음

## 32위: TerraScope: Pixel-Grounded Visual Reasoning for Earth Observation

- arXiv: http://arxiv.org/abs/2603.19039v1 | 2026-03-19 | final 66.4

Vision-language models (VLMs) have shown promise in earth observation (EO), yet they struggle with tasks that require grounding complex spatial reasoning in precise pixel-level visual representations. To address this problem, we introduce TerraScope, a unified VLM that delivers pixel-grounded geospatial reasoning with two key capabilities: (1) modality-flexible reasoning: it handles single-modality inputs (optical or SAR) and adaptively fuses different modalities into the reasoning process when both are available; (2) multi-temporal reasoning: it integrates temporal sequences for change analysis across multiple time points.

-> Pixel-level visual reasoning techniques indirectly applicable to sports analysis

## 33위: Correlation-Weighted Multi-Reward Optimization for Compositional Generation

- arXiv: http://arxiv.org/abs/2603.18528v1 | 2026-03-19 | final 66.4

Text-to-image models produce images that align well with natural language prompts, but compositional generation has long been a central challenge. Models often struggle to satisfy multiple concepts within a single prompt, frequently omitting some concepts and resulting in partial success.

-> Multi-concept image generation techniques could be indirectly applicable to image enhancement in sports photography

## 34위: Off-Policy Learning with Limited Supply

- arXiv: http://arxiv.org/abs/2603.18702v1 | 2026-03-19 | final 66.4

We study off-policy learning (OPL) in contextual bandits, which plays a key role in a wide range of real-world applications such as recommendation systems and online advertising. Typical OPL in contextual bandits assumes an unconstrained environment where a policy can select the same item infinitely.

-> 제한된 공급 컨텍스트 밴딧으로 스포츠 콘텐츠 추천 시스템에 잠재적 적용 가능

## 35위: Statistical Characteristic-Guided Denoising for Rapid High-Resolution Transmission Electron Microscopy Imaging

- arXiv: http://arxiv.org/abs/2603.18834v1 | 2026-03-19 | final 66.4

High-Resolution Transmission Electron Microscopy (HRTEM) enables atomic-scale observation of nucleation dynamics, which boosts the studies of advanced solid materials. Nonetheless, due to the millisecond-scale rapid change of nucleation, it requires short-exposure rapid imaging, leading to severe noise that obscures atomic positions.

-> Image denoising techniques could be adapted for sports video enhancement

## 36위: CustomTex: High-fidelity Indoor Scene Texturing via Multi-Reference Customization

- arXiv: http://arxiv.org/abs/2603.19121v1 | 2026-03-19 | final 65.6
...
-> Image enhancement techniques could be indirectly applicable to sports photography enhancement

## 37위: Multimodal Model for Computational Pathology:Representation Learning and Image Compression

- arXiv: http://arxiv.org/abs/2603.18660v1 | 2026-03-19 | final 64.0
...
-> Multimodal representation learning techniques indirectly applicable to sports analysis

## 38위: Revisiting OmniAnomaly for Anomaly Detection: performance metrics and comparison with PCA-based models

- arXiv: http://arxiv.org/abs/2603.18985v1 | 2026-03-19 | final 64.0
...
-> Anomaly detection in multivariate time series could be indirectly applicable for detecting unusual patterns in sports performance.

## 39위: ZEBRAARENA: A Diagnostic Simulation Environment for Studying Reasoning-Action Coupling in Tool-Augmented LLMs

- arXiv: http://arxiv.org/abs/2603.18614v1 | 2026-03-19 | final 64.0

Tool-augmented large language models (LLMs) must tightly couple multi-step reasoning with external actions, yet existing benchmarks often confound this interplay with complex environment dynamics, memorized knowledge or dataset contamination. In this paper, we introduce ZebraArena, a procedurally generated diagnostic environment for studying reasoning-action coupling in tool-augmented LLMs, with controllable difficulty and a knowledge-minimal design, which limits gains from memorization or dataset contamination.

-> LLM 도구 증강 프레임워크로 스포츠 분석에 잠재적 적용 가능

## 40위: MeInTime: Bridging Age Gap in Identity-Preserving Face Restoration

- arXiv: http://arxiv.org/abs/2603.18645v1 | 2026-03-19 | final 62.4
...
-> 얼굴 복원 기술이 이미지 향상 측면에서 적용 가능하지만 스포츠 전용은 아님

## 41위: Recolour What Matters: Region-Aware Colour Editing via Token-Level Diffusion

- arXiv: http://arxiv.org/abs/2603.18466v1 | 2026-03-19 | final 62.4

Colour is one of the most perceptually salient yet least controllable attributes in image generation. Although recent diffusion models can modify object colours from user instructions, their results often deviate from the intended hue, especially for fine-grained and local edits.

-> 색상 편집 기술이 이미지/비디오 향상 측면에서 간접적으로 관련될 수 있음

## 42위: Follow the Rules (or Not): Community Norms and AI-Generated Support in Online Health Communities

- arXiv: http://arxiv.org/abs/2603.19093v1 | 2026-03-19 | final 61.6

Generative AI (GenAI) is increasingly being integrated into the online ecosystem, including online health communities (OHCs), where people with diverse health conditions exchange social support. For example, in OHCs, support providers are beginning to share content generated, directly or indirectly, by popular GenAI-based tools.

-> AI 생성 콘텐츠 규범으로 스포츠 커뮤니티 플랫폼에 잠재적 적용 가능

## 43위: From ex(p) to poly: Gaussian Splatting with Polynomial Kernels

- arXiv: http://arxiv.org/abs/2603.18707v1 | 2026-03-19 | final 60.0

Recent advancements in Gaussian Splatting (3DGS) have introduced various modifications to the original kernel, resulting in significant performance improvements. However, many of these kernel changes are incompatible with existing datasets optimized for the original Gaussian kernel, presenting a challenge for widespread adoption.

-> 가우시안 스플래팅 개선 기술이 비디오 처리 측면에서 간접적으로 관련될 수 있음

## 44위: Interpretable Prostate Cancer Detection using a Small Cohort of MRI Images

- arXiv: http://arxiv.org/abs/2603.18460v1 | 2026-03-19 | final 60.0

Prostate cancer is a leading cause of mortality in men, yet interpretation of T2-weighted prostate MRI remains challenging due to subtle and heterogeneous lesions. We developed an interpretable framework for automatic cancer detection using a small dataset of 162 T2-weighted images (102 cancer, 60 normal), addressing data scarcity through transfer learning and augmentation.

-> 의료 영상 분석에서 사용된 효율적인 모델 설계가 엣지 디바이스에 적용 가능

## 45위: T-QPM: Enabling Temporal Out-Of-Distribution Detection and Domain Generalization for Vision-Language Models in Open-World

- arXiv: http://arxiv.org/abs/2603.18481v1 | 2026-03-19 | final 52.0
...
-> 시간적 분포 변화 감지 기술이 비디오 분석에 약간 적용 가능

## 46위: Adaptive Decoding via Test-Time Policy Learning for Self-Improving Generation

- arXiv: http://arxiv.org/abs/2603.18428v1 | 2026-03-19 | final 52.0

Decoding strategies largely determine the quality of Large Language Model (LLM) outputs, yet widely used heuristics such as greedy or fixed temperature/top-p decoding are static and often task-agnostic, leading to suboptimal or inconsistent generation quality across domains that demand stylistic or structural flexibility. We introduce a reinforcement learning-based decoder sampler that treats decoding as sequential decision-making and learns a lightweight policy to adjust sampling parameters at test-time while keeping LLM weights frozen.

-> Reinforcement learning approaches could potentially be adapted for sports video analysis

## 47위: Learning to Self-Evolve

- arXiv: http://arxiv.org/abs/2603.18620v1 | 2026-03-19 | final 52.0

We introduce Learning to Self-Evolve (LSE), a reinforcement learning framework that trains large language models (LLMs) to improve their own contexts at test time. We situate LSE in the setting of test-time self-evolution, where a model iteratively refines its context from feedback on seen problems to perform better on new ones.

-> Self-evolution concepts could potentially be adapted for improving sports analysis models

## 48위: Where are the Hidden Gems? Applying Transformer Models for Design Discussion Detection

- arXiv: http://arxiv.org/abs/2603.18393v1 | 2026-03-19 | final 52.0

Design decisions are at the core of software engineering and appear in Q\&A forums, mailing lists, pull requests, issue trackers, and commit messages. Design discussions spanning a project's history provide valuable information for informed decision-making, such as refactoring and software modernization.

-> Transformer techniques could potentially be adapted for analyzing sports-related text content

---

## 다시 보기

### SpiderCam: Low-Power Snapshot Depth from Differential Defocus (1회째 추천)
...
### A spatio-temporal graph-based model for team sports analysis (1회째 추천)
...
### Advancing Visual Reliability: Color-Accurate Underwater Image Enhancement for Real-Time Underwater Missions (2회째 추천)
...
### Universal Skeleton Understanding via Differentiable Rendering and MLLMs (1회째 추천)
...
### Efficient Reasoning on the Edge (2회째 추천)
...
### Emotion-Aware Classroom Quality Assessment Leveraging IoT-Based Real-Time Student Monitoring (2회째 추천)
...
### SpikeCLR: Contrastive Self-Supervised Learning for Few-Shot Event-Based Vision using Spiking Neural Networks (2회째 추천)
...
### Deep Reinforcement Learning-driven Edge Offloading for Latency-constrained XR pipelines (2회째 추천)
...
### Unified Spatio-Temporal Token Scoring for Efficient Video VLMs (1회째 추천)
...
### AdapTS: Lightweight Teacher-Student Approach for Multi-Class and Continual Visual Anomaly Detection (1회째 추천)
...
### DST-Net: A Dual-Stream Transformer with Illumination-Independent Feature Guidance and Multi-Scale Spatial Convolution for Low-Light Image Enhancement (2회째 추천)
...
### PA-LVIO: Real-Time LiDAR-Visual-Inertial Odometry and Mapping with Pose-Only Bundle Adjustment (2회째 추천)
...
### SE(3)-LIO: Smooth IMU Propagation With Jointly Distributed Poses on SE(3) Manifold for Accurate and Robust LiDAR-Inertial Odometry (2회째 추천)
...
### Collaborative Temporal Feature Generation via Critic-Free Reinforcement Learning for Cross-User Sensor-Based Activity Recognition (2회째 추천)
...
### Knowledge Distillation for Collaborative Learning in Distributed Communications and Sensing (2회째 추천)
...
### On the Cone Effect and Modality Gap in Medical Vision-Language Embeddings (1회째 추천)
...
### The Unreasonable Effectiveness of Text Embedding Interpolation for Continuous Image Steering (1회째 추천)
...
### Joint Degradation-Aware Arbitrary-Scale Super-Resolution for Variable-Rate Extreme Image Compression (1회째 추천)
...
### Revisiting Cross-Attention Mechanisms: Leveraging Beneficial Noise for Domain-Adaptive Learning (1회째 추천)
...
### Motion-Adaptive Temporal Attention for Lightweight Video Generation with Stable Diffusion (1회째 추천)
...
### MessyKitchens: Contact-rich object-level 3D scene reconstruction (2회째 추천)
...
### Rethinking Pose Refinement in 3D Gaussian Splatting under Pose Prior and Geometric Uncertainty (2회째 추천)
...
### BLADE: Adaptive Wi-Fi Contention Control for Next-Generation Real-Time Communication (2회째 추천)
...
### ChopGrad: Pixel-Wise Losses for Latent Video Diffusion via Truncated Backpropagation (1회째 추천)
...
### Prompt-Free Universal Region Proposal Network (1회째 추천)
...
### A Creative Agent is Worth a 64-Token Template (1회째 추천)
...
### Enabling Real-Time Programmability for RAN Functions: A Wasm-Based Approach for Robust and High-Performance dApps (1회째 추천)
...
### CrowdGaussian: Reconstructing High-Fidelity 3D Gaussians for Human Crowd from a Single Image (1회째 추천)
...
### From Digital Twins to World Models:Opportunities, Challenges, and Applications for Mobile Edge General Intelligence (1회째 추천)
...
### Change is Hard: Consistent Player Behavior Across Games with Conflicting Incentives (2회째 추천)
...
### LICA: Layered Image Composition Annotations for Graphic Design Research (2회째 추천)
...
### GATS: Gaussian Aware Temporal Scaling Transformer for Invariant 4D Spatio-Temporal Point Cloud Representation (2회째 추천)
...
### SparkVSR: Interactive Video Super-Resolution via Sparse Keyframe Propagation (2회째 추천)
...
### EPOFusion: Exposure aware Progressive Optimization Method for Infrared and Visible Image Fusion (2회째 추천)
...
### SegFly: A 2D-3D-2D Paradigm for Aerial RGB-Thermal Semantic Segmentation at Scale (1회째 추천)
...
### TINA: Text-Free Inversion Attack for Unlearned Text-to-Image Diffusion Models (1회째 추천)
...
### TAPESTRY: From Geometry to Appearance via Consistent Turntable Videos (1회째 추천)
...
### FineViT: Progressively Unlocking Fine-Grained Perception with Dense Recaptions (1회째 추천)
...
### VLM2Rec: Resolving Modality Collapse in Vision-Language Model Embedders for Multimodal Sequential Recommendation (1회째 추천)
...
### AR-CoPO: Align Autoregressive Video Generation with Contrastive Policy Optimization (1회째 추천)
...
### Feeling the Space: Egomotion-Aware Video Representation for Efficient and Accurate 3D Scene Understanding (1회째 추천)
...
### M^3: Dense Matching Meets Multi-View Foundation Models for Monocular Gaussian Splatting SLAM (2회째 추천)
...
### Learning Human-Object Interaction for 3D Human Pose Estimation from LiDAR Point Clouds (2회째 추천)
...
### When Thinking Hurts: Mitigating Visual Forgetting in Video Reasoning via Frame Repetition (2회째 추천)
...
### TinyGLASS: Real-Time Self-Supervised In-Sensor Anomaly Detection (2회째 추천)
...
### Large Reward Models: Generalizable Online Robot Reward Generation with Vision-Language Models (2회째 추천)
...
### Demystifing Video Reasoning (2회째 추천)
...
### Optimal uncertainty bounds for multivariate kernel regression under bounded noise: A Gaussian process-based dual function (2회째 추천)
...
### Learning Whole-Body Control for a Salamander Robot (2회째 추천)
...
### Interpretable Cross-Domain Few-Shot Learning with Rectified Target-Domain Local Alignment (1회째 추천)
...
### EchoGen: Cycle-Consistent Learning for Unified Layout-Image Generation and Understanding (1회째 추천)
...
### ReLaGS: Relational Language Gaussian Splatting (1회째 추천)
...
### VirPro: Visual-referred Probabilistic Prompt Learning for Weakly-Supervised Monocular 3D Detection (1회째 추천)
...
### Steering Video Diffusion Transformers with Massive Activations (1회째 추천)

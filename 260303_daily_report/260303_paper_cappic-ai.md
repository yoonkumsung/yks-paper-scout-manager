# CAPP!C_AI 논문 리포트 (2026-03-03)

> 수집 94 | 필터 88 | 폐기 0 | 평가 40 | 출력 40 | 기준 50점

검색 윈도우: 2026-03-02T00:00:00+00:00 ~ 2026-03-03T00:30:00+00:00 | 임베딩: en_synthetic | run_id: 27
...
## 1위: OnlineX: Unified Online 3D Reconstruction and Understanding with Active-to-Stable State Evolution
...
**활용 인사이트**
스트리밍 영상으로 3D 장면 재구성하여 실시간 경기 분석 및 하이라이트 생성 가능

## 2위: Search Multilayer Perceptron-Based Fusion for Efficient and Accurate Siamese Tracking
...
**활용 인사이트**
MLP 기반 융합 모듈로 선수 실시간 추적 및 동작 분석에 효과적

## 3위: Stereo-Inertial Poser: Towards Metric-Accurate Shape-Aware Motion Capture Using Sparse IMUs and a Single Stereo Camera
...
**활용 인사이트**
스테레오 카메라와 IMU 결합하여 선수의 정확한 동작 및 자세 분석

## 4위: PPEDCRF: Privacy-Preserving Enhanced Dynamic CRF for Location-Privacy Protection for Sequence Videos with Minimal Detection Degradation

- arXiv: http://arxiv.org/abs/2603.01593v1
- PDF: https://arxiv.org/pdf/2603.01593v1
- 코드: https://github.com/mabo1215/PPEDCRF.git
- 발행일: 2026-03-02
- 카테고리: cs.CV
- 점수: final 92.8 (llm_adjusted:91 = base:78 + bonus:+13)
- 플래그: 엣지, 실시간, 코드 공개
...
**활용 인사이트**
민감한 영역 보호하면서 객체 감지 성능 유지하여 콘텐츠 공유 보안 강화

## 5위: Kiwi-Edit: Versatile Video Editing via Instruction and Reference Guidance

- arXiv: http://arxiv.org/abs/2603.02175v1
- PDF: https://arxiv.org/pdf/2603.02175v1
- 코드: https://github.com/showlab/Kiwi-Edit
- 발행일: 2026-03-02
- 카테고리: cs.CV, cs.AI
...
**활용 인사이트**
참조 이미지와 지침으로 정교한 하이라이트 편집 및 콘텐츠 생성 가능

## 6위: Downstream Task Inspired Underwater Image Enhancement: A Perception-Aware Study from Dataset Construction to Network Design

- arXiv: http://arxiv.org/abs/2603.01767v1
- PDF: https://arxiv.org/pdf/2603.01767v1
- 코드: https://github.com/oucailab/DTIUIE
- 발행일: 2026-03-02
- 카테고리: cs.CV, eess.IV
...
**활용 인사이트**
다운스트림 작업 인식 네트워크를 스포츠 장면에 맞게 튜닝하여 실시간 영상 보정 및 하이라이트 생성 성능 개선

## 7위: WildCross: A Cross-Modal Large Scale Benchmark for Place Recognition and Metric Depth Estimation in Natural Environments
...
## 8위: SeaVIS: Sound-Enhanced Association for Online Audio-Visual Instance Segmentation
...
**활용 인사이트**
CCAF 모듈과 AGCL 전략을 적용하여 소리를 내는 선수와 침묵하는 선수를 정확히 구분하고 실시간 추적 성능 최적화

## 9위: Orchestrating Multimodal DNN Workloads in Wireless Neural Processing
...
**활용 인사이트**
O-WiN 프레임워크와 PACS 알고리즘을 적용하여 무선 데이터 전송과 DNN 실행을 겹치게 처리함으로써 다중 모달 스포츠 영상 분석의 처리 속도를 향상시키고 실시간 하이라이트 생성을 가능하게 합니다.

## 10위: NextAds: Towards Next-generation Personalized Video Advertising
...
**활용 인사이트**
GenAI를 활용한 실시간 맞춤형 광고 생성 시스템 구축으로 사용자 참여도와 광고 효과 동시 향상

## 11위: Boosting AI Reliability with an FSM-Driven Streaming Inference Pipeline: An Industrial Case

- arXiv: http://arxiv.org/abs/2603.01528v1
- PDF: https://arxiv.org/pdf/2603.01528v1
- 코드: https://github.com/thulab/video-streamling-inference-pipeline
- 발행일: 2026-03-02
- 카테고리: cs.CV
...
**활용 인사이트**
어안렌즈를 장착한 엣지 디바이스로 스포츠 전체 장면 캡처, RSA 전략으로 다양한 스포츠 환경에 적응

## 12위: Rethinking Camera Choice: An Empirical Study on Fisheye Camera Properties in Robotic Manipulation
...
**활용 인사이트**
AOT 알고리즘을 영상 분석 파이프라인에 적용해 스포츠 영상 처리 속도 향상, 품유지하며 하이라이트 자동 생성

## 13위: WorldStereo: Bridging Camera-Guided Video Generation and Scene Reconstruction via 3D Geometric Memories
...
**활용 인사이트**
3D 기하 메모리를 활용한 스포츠 콘텐츠 생성으로 고품질 경기 장면 복원 및 분석 가능

## 14위: Token Reduction via Local and Global Contexts Optimization for Efficient Video Large Language Models
...
## 15위: MSP-ReID: Hairstyle-Robust Cloth-Changing Person Re-Identification

- arXiv: http://arxiv.org/abs/2603.01640v1
- PDF: https://arxiv.org/pdf/2603.01640v1
- 발행일: 2026-03-02
- 카테고리: cs.CV
...
**활용 인사이트**
선수의 옷 변화에도 일관되게 추적하여 경기 분석과 하이라이트 편집에 활용 가능

## 16위: InterCoG: Towards Spatially Precise Image Editing with Interleaved Chain-of-Grounding Reasoning

- arXiv: http://arxiv.org/abs/2603.01586v1
- PDF: https://arxiv.org/pdf/2603.01586v1
- 발행일: 2026-03-02
- 카테고리: cs.CV
...
**활용 인사이트**
텍스트-비전 연쇄적 추론 프레임워크를 활용해 스포츠 영상 내 특정 객체나 장면을 정밀하게 식별하고 편집

## 17위: Training-Free Spatio-temporal Decoupled Reasoning Video Segmentation with Adaptive Object Memory

- arXiv: http://arxiv.org/abs/2603.01545v1
...
**선정 근거**
트레이닝 프리 비디오 분할 프레임워크로 스포츠 하이라이트 자동 식별 및 추출에 적합

**활용 인사이트**
적응형 객체 메모리와 시공간 분리 기법을 활용해 실시간으로 스포츠 경기 중 중요한 순간을 추출하고 분석

## 18위: Mean-Flow based One-Step Vision-Language-Action
...
**선정 근거**
비전-언어-행동 모델이 스포츠 동작 분석에 적용 가능하며, 8.7배 빠른 생성 속도가 엣지 디바이스에서 실시간 처리에 필수적입니다.

**활용 인사이트**
한 단계 생성 접근법을 스포츠 영상 분석에 적용해 실시간 동작 인식과 하이라이트 자동 편집 시스템 구축 가능합니다.

## 19위: Learning Vision-Based Omnidirectional Navigation: A Teacher-Student Approach Using Monocular Depth Estimation

- arXiv: http://arxiv.org/abs/2603.01999v1
- PDF: https://arxiv.org/pdf/2603.01999v1
- 발행일: 2026-03-02
- 카테고리: cs.RO, cs.CV, cs.LG
...
**선정 근거**
엣지 기기에서 실시간 비전 처리 기술을 사용하지만 로봇 내비게이션에 초점을 맞춤

## 20위: Streaming Real-Time Trajectory Prediction Using Endpoint-Aware Modeling

- arXiv: http://arxiv.org/abs/2603.01864v1
...
**선정 근거**
Real-time streaming processing approach could be applicable to edge device requirements for sports video analysis

## 21위: LEAR: Learning Edge-Aware Representations for Event-to-LiDAR Localization

- arXiv: http://arxiv.org/abs/2603.01839v1
- PDF: https://arxiv.org/pdf/2603.01839v1
- 발행일: 2026-03-02
- 카테고리: cs.CV, cs.RO
...
**선정 근거**
이벤트 카메라의 고속 촬영 기술과 에지 인식 알고리즘을 스포츠 장면의 자동 촬영 및 주요 순간 포착에 적용할 수 있습니다.

**활용 인사이트**
LEAR의 에지 구조 추출과 깊이 흐름장 계산 기술을 결합하여 선수들의 움직임을 정밀하게 추적하고, 고속 움직임 환경에서도 안정적인 자세 분석이 가능합니다.

## 22위: PromptStereo: Zero-Shot Stereo Matching via Structure and Motion Prompts

- arXiv: http://arxiv.org/abs/2603.01650v1
- PDF: https://arxiv.org/pdf/2603.01650v1
- 발행일: 2026-03-02
- 카테고리: cs.CV
...
**선정 근거**
스테레오 매칭 기술이 스포츠 장면의 깊이 인식에 간접적으로 적용 가능

## 23위: MobileMold: A Smartphone-Based Microscopy Dataset for Food Mold Detection

- arXiv: http://arxiv.org/abs/2603.01944v1
- PDF: https://arxiv.org/pdf/2603.01944v1
- 코드: https://mobilemold.github.io/dataset/
- 발행일: 2026-03-02
- 카테고리: cs.CV
...
**선정 근거**
Smartphone-based imaging techniques could be applicable to the edge device aspect but designed for mold detection rather than sports.

## 24위: ATA: Bridging Implicit Reasoning with Attention-Guided and Action-Guided Inference for Vision-Language Action Models

- arXiv: http://arxiv.org/abs/2603.01490v1
- PDF: https://arxiv.org/pdf/2603.01490v1
- 발행일: 2026-03-02
- 카테고리: cs.CV, cs.AI
- 점수: final 73.6 (llm_adjusted:67 = base:62 + bonus:+5)
- 플래그: 엣지
...
**선정 근거**
암시적 추론을 통한 비전-언어-행동 모델이 스포츠 분석에 간접적으로 적용 가능하여 실시간 동작 분석에 효과적

**활용 인사이트**
스포츠 영상에서 선수들의 움직임과 경기 전략을 실시간으로 분석하고, 시각적 주의도를 기반으로 중요한 순간을 자동으로 식별하여 하이라이트 영상을 생성하는 데 적용 가능

## 25위: MMR-Life: Piecing Together Real-life Scenes for Multimodal Multi-image Reasoning

- arXiv: http://arxiv.org/abs/2603.02024v1
...
**선정 근거**
다중 모달 추론 벤치마크는 스포츠 영상 분석에 간접적으로 참조 가능

## 26위: Non-Markovian Long-Horizon Robot Manipulation via Keyframe Chaining

- arXiv: http://arxiv.org/abs/2603.01465v1
- PDF: https://arxiv.org/pdf/2603.01465v1
- 코드: https://github.com/cytoplastm/KC-VLA
- 발행일: 2026-03-02
- 카테고리: cs.RO, cs.AI
...
**선정 근거**
키프레임 체이닝 기술이 스포츠 하이라이트 영상 생성에 간접적으로 적용 가능

**활용 인사이트**
경기 중 중요한 순간을 식별하고 연결하여 자동으로 하이라이트 영상 생성 가능

## 27위: LiftAvatar: Kinematic-Space Completion for Expression-Controlled 3D Gaussian Avatar Animation

- arXiv: http://arxiv.org/abs/2603.02129v1
...
**선정 근거**
3D 아바타 애니메이션 기술로 스포츠 영상 처리에 간접적으로 관련

**활용 인사이트**
저해상도 영상을 고화질로 보정하고 시간적 일관성 유지하여 스포츠 영상 품질 향상

## 28위: Affine Correspondences in Stereo Vision: Theory, Practice, and Limitations

- arXiv: http://arxiv.org/abs/2603.01836v1
- PDF: https://arxiv.org/pdf/2603.01836v1
- 발행일: 2026-03-02
- 카테고리: cs.CV
- 점수: final 68.0 (llm_adjusted:60 = base:60 + bonus:+0)
...
**선정 근거**
컴퓨터 비전 기술로 3D 재구성에 관련되어 있으나 스포츠 촬영이나 분석과 직접적인 연관은 없음

**활용 인사이트**
스테레오 비전 기술을 활용한 3D 재구성으로 스포츠 경기의 입체적 시청 경험 제공 가능

## 29위: The USTC-NERCSLIP Systems for the CHiME-9 MCoRec Challenge

- arXiv: http://arxiv.org/abs/2603.01415v1
- PDF: https://arxiv.org/pdf/2603.01415v1
- 발행일: 2026-03-02
- 카테고리: eess.AS
...
**선정 근거**
다중 채널 오디오-비전 처리 기술이 영상 분석과 관련 있으나 실내 음성 인식에 중점

**활용 인사이트**
멀티모달 오디오-비전 처리 기술을 스포츠 경기의 음성 분석에 적용 가능

## 30위: Leveraging Model Soups to Classify Intangible Cultural Heritage Images from the Mekong Delta

- arXiv: http://arxiv.org/abs/2603.02181v1
...
**선정 근거**
이미지 분류 기술로 스포츠 분석에 적용 가능하나 스포츠 장면을 특별히 고려하지 않음

**활용 인사이트**
모델 수프 기법을 스포츠 장면 분류에 적용하여 적은 데이터로도 정확한 분석 가능

## 31위: OMG-Avatar: One-shot Multi-LOD Gaussian Head Avatar

- arXiv: http://arxiv.org/abs/2603.01506v1 | 2026-03-02 | final 66.4

We propose OMG-Avatar, a novel One-shot method that leverages a Multi-LOD (Level-of-Detail) Gaussian representation for animatable 3D head reconstruction from a single image in 0.2s. Our method enables LOD head avatar modeling using a unified model that accommodates diverse hardware capabilities and inference speed requirements.

-> 3D 헤드 아바타 생성 기술이 스포츠 영상 향상에 간접적으로 적용 가능

## 32위: Deepfake Forensics Adapter: A Dual-Stream Network for Generalizable Deepfake Detection

- arXiv: http://arxiv.org/abs/2603.01450v1 | 2026-03-02 | final 66.4

The rapid advancement of deepfake generation techniques poses significant threats to public safety and causes societal harm through the creation of highly realistic synthetic facial media. While existing detection methods demonstrate limitations in generalizing to emerging forgery patterns, this paper presents Deepfake Forensics Adapter (DFA), a novel dual-stream framework that synergizes vision-language foundation models with targeted forensics analysis.

-> Video/image analysis techniques could be applicable but focused on deepfake detection rather than sports content

## 33위: Preoperative-to-intraoperative Liver Registration for Laparoscopic Surgery via Latent-Grounded Correspondence Constraints

- arXiv: http://arxiv.org/abs/2603.01720v1 | 2026-03-02 | final 66.4

In laparoscopic liver surgery, augmented reality technology enhances intraoperative anatomical guidance by overlaying 3D liver models from preoperative CT/MRI onto laparoscopic 2D views. However, existing registration methods lack explicit modeling of reliable 2D-3D geometric correspondences supported by latent evidence, leading to limited interpretability and potentially unstable alignment in clinical scenarios.

-> 의료 영상 등록 기술이 스포츠 분석에 간접적으로 적용 가능

## 34위: B$^2$F-Map: Crowd-sourced Mapping with Bayesian B-spline Fusion

- arXiv: http://arxiv.org/abs/2603.01673v1 | 2026-03-02 | final 64.8

Crowd-sourced mapping offers a scalable alternative to creating maps using traditional survey vehicles. Yet, existing methods either rely on prior high-definition (HD) maps or neglect uncertainties in the map fusion.

-> 지도 생성 및 위치 결정 기술이 스포츠 장면 분석에 간접적으로 적용 가능

## 35위: Retrieval, Refinement, and Ranking for Text-to-Video Generation via Prompt Optimization and Test-Time Scaling

- arXiv: http://arxiv.org/abs/2603.01509v1 | 2026-03-02 | final 64.0

While large-scale datasets have driven significant progress in Text-to-Video (T2V) generative models, these models remain highly sensitive to input prompts, demonstrating that prompt design is critical to generation quality. Current methods for improving video output often fall short: they either depend on complex, post-editing models, risking the introduction of artifacts, or require expensive fine-tuning of the core generator, which severely limits both scalability and accessibility.

-> Video generation optimization techniques could be applicable but focused on text-to-video generation

## 36위: Sparse View Distractor-Free Gaussian Splatting

- arXiv: http://arxiv.org/abs/2603.01603v1 | 2026-03-02 | final 64.0

3D Gaussian Splatting (3DGS) enables efficient training and fast novel view synthesis in static environments. To address challenges posed by transient objects, distractor-free 3DGS methods have emerged and shown promising results when dense image captures are available.

-> 3D scene understanding techniques could be applicable but focused on view synthesis rather than sports analysis

## 37위: From Leaderboard to Deployment: Code Quality Challenges in AV Perception Repositories

- arXiv: http://arxiv.org/abs/2603.02194v1 | 2026-03-02 | final 64.0
...
-> 인식 시스템의 코드 품질 연구가 엣지 디바이스 개발에 간접적으로 관련

## 38위: Guaranteed Image Classification via Goal-oriented Joint Semantic Source and Channel Coding

- arXiv: http://arxiv.org/abs/2603.01872v1 | 2026-03-02 | final 64.0

To enable critical applications such as remote diagnostics, image classification must be guaranteed under bandwidth constraints and unreliable wireless channels through joint source and channel coding (JSCC) design. However, most existing JSCC methods focus on minimizing image distortion, implicitly assuming that all image regions contribute equally to classification performance, thereby overlooking their varying importance for the task.

-> Semantic importance ranking for image classification could be applicable to sports analysis but focused on transmission rather than on-device processing.

## 39위: MixerCSeg: An Efficient Mixer Architecture for Crack Segmentation via Decoupled Mamba Attention

- arXiv: http://arxiv.org/abs/2603.01361v1 | 2026-03-02 | final 54.4

Feature encoders play a key role in pixel-level crack segmentation by shaping the representation of fine textures and thin structures. Existing CNN-, Transformer-, and Mamba-based models each capture only part of the required spatial or structural information, leaving clear gaps in modeling complex crack patterns.

-> 효율적인 아키텍처는 스포츠 영상 처리에 잠재적 적용 가능성 있으나 특정 분할 작업에 특화

## 40위: MMNavAgent: Multi-Magnification WSI Navigation Agent for Clinically Consistent Whole-Slide Analysis

- arXiv: http://arxiv.org/abs/2603.02079v1 | 2026-03-02 | final 50.4

Recent AI navigation approaches aim to improve Whole-Slide Image (WSI) diagnosis by modeling spatial exploration and selecting diagnostically relevant regions, yet most operate at a single fixed magnification or rely on predefined magnification traversal. In clinical practice, pathologists examine slides across multiple magnifications and selectively inspect only necessary scales, dynamically integrating global and cellular evidence in a sequential manner.

-> 다중 배율 탐색 개념은 추상적으로 스포츠 분석에 적용 가능하나 의료 영상에 특화

---

## 다시 보기

### No Labels, No Look-Ahead: Unsupervised Online Video Stabilization with Classical Priors (1회째 추천)
...
### U-Net-Based Generative Joint Source-Channel Coding for Wireless Image Transmission (1회째 추천)
...
### SCOPE: Skeleton Graph-Based Computation-Efficient Framework for Autonomous UAV Exploration (1회째 추천)
...
### UniScale: Unified Scale-Aware 3D Reconstruction for Multi-View Understanding via Prior Injection for Robotic Perception (1회째 추천)
...
### MovieTeller: Tool-augmented Movie Synopsis with ID Consistent Progressive Abstraction (1회째 추천)
...
### BRIDGE: Borderless Reconfiguration for Inclusive and Diverse Gameplay Experience via Embodiment Transformation (1회째 추천)
...
### Align then Adapt: Rethinking Parameter-Efficient Transfer Learning in 4D Perception (1회째 추천)
...
### Velocity and stroke rate reconstruction of canoe sprint team boats based on panned and zoomed video recordings (1회째 추천)
...
### UCM: Unifying Camera Control and Memory with Time-aware Positional Encoding Warping for World Models (1회째 추천)
...
### Learning Continuous Wasserstein Barycenter Space for Generalized All-in-One Image Restoration (1회째 추천)
...
### Towards Long-Form Spatio-Temporal Video Grounding (1회째 추천)
...
### LoR-LUT: Learning Compact 3D Lookup Tables via Low-Rank Residuals (1회째 추천)
...
### Doubly Adaptive Channel and Spatial Attention for Semantic Image Communication by IoT Devices (1회째 추천)
...
### GeoMotion: Rethinking Motion Segmentation via Latent 4D Geometry (2회째 추천)
...
### Efficient Real-Time Adaptation of ROMs for Unsteady Flows Using Data Assimilation (1회째 추천)
...
### FLIGHT: Fibonacci Lattice-based Inference for Geometric Heading in real-Time (1회째 추천)
...
### GSTurb: Gaussian Splatting for Atmospheric Turbulence Mitigation (1회째 추천)
...
### TEFL: Prediction-Residual-Guided Rolling Forecasting for Multi-Horizon Time Series (1회째 추천)
...
### Locally Adaptive Decay Surfaces for High-Speed Face and Landmark Detection with Event Cameras (1회째 추천)
...
### PackUV: Packed Gaussian UV Maps for 4D Volumetric Video (1회째 추천)
...
### From Statics to Dynamics: Physics-Aware Image Editing with Latent Transition Priors (2회째 추천)
...
### Beyond Detection: Multi-Scale Hidden-Code for Natural Image Deepfake Recovery and Factual Retrieval (1회째 추천)
...
### SOTAlign: Semi-Supervised Alignment of Unimodal Vision and Language Models via Optimal Transport (1회째 추천)
